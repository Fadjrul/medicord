...
class Pegawai extends CI_Controller {
    ...
    public function index() {
        ...
        $data['pasien']        = $this->m_pegawai->read($perPage, $page,'');
    ...
    public function search() {
        ...
        $data['setting']       = getSetting();
        $data['title']         = 'Data Pegawai';
        $data['pasien']        = $this->m_pegawai->read($perPage, $page, $data['search']);
    ...
    public function create() {
        ...
        // LOG
        $message    = $this->session->userdata('user_name')." menambah data pegawai ".$data['nama_pegawai'];
        createLog($message);
