                ...
                <div class="card-content">
                    <div class="row me-4">
                        <div class="col-md-12 col-12 text-end">
                            <a href="<?= site_url('dokter/create_page'); ?>" class="btn btn-sm btn-primary">
                                                    ...
                                                    <td>
                                                        <div class="btn-group dropstart mb-1">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <?php echo form_open("dokter/detail_page/" . $key->id_dokter); ?>
                                                                    <?php echo csrf(); ?>
                                                                    <button type="submit" class="dropdown-item">Detail</button>
                                                                    <input type="hidden" class="form-control" name="id_dokter" required="required">
                                                                    <?php echo form_close(); ?>
                                                                </li>
                                                                <li>
                                                                    <?php echo form_open("dokter/update_page/" . $key->id_dokter); ?>
                                                                    <?php echo csrf(); ?>
